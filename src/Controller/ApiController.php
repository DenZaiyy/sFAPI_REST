...
final class ApiController extends AbstractController
{
    ...
    public function index(ApiHttpClient $apiHttpClient): Response
    {
        ...
        return $this->render('api/users/index.html.twig', [
            'users' => $users,
        ]);
    }

    #[Route('/users/add-members', name: 'member_add', methods: ['POST'])]
    public function addMembers(EntityManagerInterface $entityManager, Request $request): RedirectResponse
    {
        $membre = new Membre();
